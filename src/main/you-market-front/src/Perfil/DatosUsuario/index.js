...
function DatosUsuario() {
  ...
  const fetchSuscripcion = useCallback(() => {
    return fetch("usuario/getSuscripcion", {
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
        Authorization: "Bearer " + localStorage.getItem("auth"),
  ...
  const fetchDireccion = useCallback(() => {
    return fetch("direccion/principal", {
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
        Authorization: "Bearer " + localStorage.getItem("auth"),
  ...
  const fetchPagoSus = useCallback(() => {
    return fetch("suscripcion/pagada", {
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
        Authorization: "Bearer " + localStorage.getItem("auth"),
  ...
  const fetchUltimaSuscripcion = useCallback(() => {
    return fetch("factura/lastSuscripcion", {
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
        Authorization: "Bearer " + localStorage.getItem("auth"),
