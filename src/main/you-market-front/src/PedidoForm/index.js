...
export function PedidoForm() {
	...
	const precio = (values) => {
		...
		const fetchTotal = useCallback(() => {
		     return fetch('https://youmarket-entrega4.herokuapp.com/precioTotalCarrito', {headers:{
		  'Content-Type' : 'application/json',
		  'Accept' : 'application/json',
		  'Authorization' : 'Bearer ' + localStorage.getItem('auth')},
		  method:'GET',
...
function pagar() {
	...
	const fetchCestas = useCallback(() => {
	    return fetch('https://youmarket-entrega4.herokuapp.com/cesta/user/llenas' , {headers: {
		'Content-Type' : 'application/json',
		'Accept' : 'application/json',
		'Authorization' : 'Bearer ' + localStorage.getItem('auth')},
		method:'GET'})
