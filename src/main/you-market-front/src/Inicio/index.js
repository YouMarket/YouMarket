		...
		<div className="homepage">
            ...
            <div className="homepage-services container">
                <div className="homepage-service service-left">
                    <img className="service-image" src={suscripcion} alt="Suscripción mensual" />
                ...
                <div className="homepage-service service-middle">
                    <img className="service-image" src={cesta} alt="Cestas personalizadas"/>
                    <div className="service-information">
                ...
                <div className="homepage-service service-middle">
                    <img className="service-image" src={dieta} alt="Dietas y recetas"/>
                    <div className="service-information">
                ...
                <div className="homepage-service service-right">
                    <img className="service-image" src={furgoneta} alt="Somos Ecofriendly"/>
                    <div className="service-information">
