...
public class CarritoSessionController {
	...
	public ResponseEntity<List<ProductoCarrito>> carritoGet(HttpSession session) {
		...
		// Map<Producto, Integer> carrito = (Map<Producto,
		// Integer>)session.getAttribute("SESSION_CARRITO");
		// if(carrito == null){
		// carrito = new HashMap<>();
		// }
		return null;
	...
	@PostMapping("/carrito")
	public List<ProductoCarrito> carritoPost(@RequestBody Map<String, Integer> postProducto, HttpServletRequest request,
			HttpSession session) {
